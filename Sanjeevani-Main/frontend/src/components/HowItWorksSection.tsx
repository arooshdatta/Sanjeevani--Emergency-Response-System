...
import { 
  Smartphone, Radio, Navigation, Hospital, FileCheck, ArrowRight
} from "lucide-react";

const steps = [
  // ... (keep the steps array exactly as it is) ...
  {
    number: "01",
    icon: Smartphone,
    title: "One-Tap SOS",
...
const HowItWorksSection = () => {
  return (
    // CHANGED THIS LINE TO bg-transparent
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            {steps.map((step, index) => (
              <motion.div
                ...
                className="relative"
              >
                {/* Step Card - Kept the solid bg-card so the boxes still look good against the new gradient! */}
