...
const SOSSection = () => {
  ...
  return (
    <section id="sos" className="py-24 md:py-40 bg-transparent min-h-[80vh] flex items-center">
      <div className="container mx-auto px-4">
        ...
        {!isActivated ? (
          <>
            ...
            >
              <Button
                variant={selectedType ? "sos" : "secondary"}
                size="sos"
                onClick={handleSOS}
                disabled={!selectedType}
                className={`mb-8 flex items-center justify-center transition-all duration-300 ${
                  selectedType ? "animate-pulse-emergency" : "opacity-80"
                }`}
              >
                <Phone className="h-8 w-8 md:h-10 md:w-10 mr-3 md:mr-4 fill-current" />
                <span className="font-bold tracking-widest uppercase whitespace-nowrap">ACTIVATE SOS</span>
              </Button>
